...
public class Test extends TestCase {
	...
	public void testAcelerar() {
		...
		// testeo que la velocidad máxima sea 50
		...
		// posición del auto1 x=5
		// posición del bot1 x=10
		// caso en que auto1 choca por la izquierda al bot1.

		auto1.chocar(bot1);

		assertEquals(auto1.getX(), 4.00); // auto1 se moverá hacia la izquierda (x=4)
		assertEquals(bot1.getX(), 11.00); // bot1 se moverá hacia la derecha (x=11)

		// El choque también puede ser frontal o trasero
		// caso en que auto1 choca a bot2 por atrás
		...
		assertEquals(auto1.getVelocidad(), 30.00); // auto1 reducirá su velocidad por el choque
		// auto1 venía con una velocidad de 40 antes del choque

		// testo el choque de un auto contra un obstáculo

		Obstaculo obstaculo1 = new Obstaculo(1, new Punto(4.00, 20.00));

		// Si el auto choca un obstáculo, explota
		// esto producirá que su velocidad se haga cero.
		auto1.chocar(obstaculo1); // dentro de chocar() se llama a explotar()

		assertEquals(auto1.getVelocidad(), 0.00);

		// testeo que si inicio la habilidad modo fantasma
		// no genera ningun efecto al chocar un obstáculo
